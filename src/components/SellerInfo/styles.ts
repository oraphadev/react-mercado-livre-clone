...
export const LocationIcon = styled(HiOutlineLocationMarker)`${iconStyle}`;
...
export const SupportIcon = styled(HiOutlineChatAlt2)`${iconStyle}`;

export const ClockIcon = styled(HiOutlineClock)`${iconStyle}`;
